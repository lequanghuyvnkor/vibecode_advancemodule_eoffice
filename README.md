...
├── docs/
│   └── module-tam-ung-hoan-ung.md   ← Spec nghiệp vụ đầy đủ: state machine, status token, business rules, API endpoints
...
2. Đọc `docs/module-tam-ung-hoan-ung.md` — spec nghiệp vụ gốc
...
5 sub-module trong Finance Engine: **Advance Request → Approval & Disbursement → Expense Verification → Settlement → Driver Balance**, gắn với luồng đóng chuyến 3 bên (Tài xế → Kế toán → Quản lý vận hành). Chi tiết đầy đủ xem `docs/module-tam-ung-hoan-ung.md`.
